...
~This program is created to help system admins in Windows maintane and operate their server.~
...
config.yml			A file that is loaded by QuickTermSE to determine certain vars like backup location and telnet settings
